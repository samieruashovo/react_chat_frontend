        ...
        <div className="container mx-auto  my-10 animate__animated animate__fadeIn">
          <div className="rounded-2xl bg-primary-neutral border border-primary-base  relative shadow-2xl">
            <div className="overflow-hidden rounded-t-2xl relative">
              ...
              <p className="absolute top-4 left-4 bg-gradient-to-r from-red-500 to-yellow-500 px-4 py-2 font-semibold text-white rounded-3xl hover:scale-110 transition duration-500">
                {category}
              </p>
            </div>
              ...
              <div className=" flex justify-end items-center gap-2 px-2">
                {user && user.username === blog.author_name ? (
                  <>
                    <button
                      onClick={handleEdit}
                      className="bg-primary-warning p-3 m-3 rounded-2xl hover:scale-95 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="bg-primary-error p-3 m-3 rounded-2xl hover:scale-95 cursor-pointer"
                    >
          ...
          <form onSubmit={handleSubmitComment}>
            ...
            <div className="flex justify-end mt-5">
              <button
                className="btn btn-sm bg-yellow-600 text-white mb-5 capitalize"
                type="submit"
              >
                Comment
              </button>
