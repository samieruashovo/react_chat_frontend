        ...
        <div className="flex flex-wrap md:flex-nowrap justify-around items-center">
          <div className="space-y-5">
            <p className="text-4xl font-semibold">
              Hi!{" "}
              <span className="text-primary-warning">{profile.username}.</span>{" "}
              welcome to
            ...
            <p className="text-lg font-semibold">
              {blogs.length > 0 ? (
                <>
                  You have written{" "}
                  <span className="text-primary-warning">{blogs.length}</span>
            ...
            <button
              className="btn btn-sm bg-yellow-600 text-white capitalize"
              to="/create"
            >
              {" "}
          ...
          <img
            className="max-w-md m-5 rounded-full"
