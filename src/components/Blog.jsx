      ...
      <div className="rounded-2xl bg-primary-neutral border-primary-neutral border relative shadow-xl">
        <div className="overflow-hidden rounded-t-2xl relative">
          <img
            ...
            alt=""
          />
          <p className="absolute top-2 left-2 bg-gradient-to-r from-red-500 to-yellow-500 px-3 py-1 text-white rounded-3xl cursor-pointer hover:scale-110 transition duration-500">
            {category}
          </p>
        </div>
        <div className="flex flex-wrap gap-4 md:justify-between px-4 pt-4">
          ...
          <div className="flex items-center md:gap-1">
            <HiOutlineCalendar className="font-semibold text-xl text-yellow-600" />
        ...
        <button className="btn btn-sm hidden md:absolute md:flex md:-bottom-4 md:left-1/3 bg-gradient-to-r from-red-600 to-yellow-500 border-none hover:scale-95 text-white hover:bg-gradient-to-r hover:from-yellow-400 hover:to-yellow-600 capitalize">
